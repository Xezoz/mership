...
type ModeratorChartsProps = {
    data: ChartData[]
    timeRange: string
    onTimeRangeChange: (range: string) => void
}

export function ModeratorCharts({ data, timeRange, onTimeRangeChange }: ModeratorChartsProps) {
    const [activeChart, setActiveChart] = React.useState<'revenue' | 'packages'>('revenue')
        ...
        <Card>
            <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
                <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
                    ...
                    <CardDescription>
                        {activeChart === 'revenue' ? 'Total revenue over time' : 'Package volume trends'}
                    </CardDescription>
                </div>
